...
void nightMode()
{
    ...
    //Full Body
        ...
        if(rain)
        {
            ...
            rainf();
           /* PlaySound("E:\\Education\\AIUB\\Projects\\Graphics\AIUB Animation\\rain.wav", NULL, SND_FILENAME);
...
void startscreen(void)
{
    ...
    glColor3f(1,1,1);
    drawstring(75,370,0.0,"ARNOB, ASHNIF HOSSAIN              (15-30149-2)");
    drawstring(75,290,0.0,"SHEAK, NAYEEM                               (14-27761-3)");
    drawstring(75,210,0.0,"REZA, FAHIM ABRAR                        (15-30090-2)");
    drawstring(75,130,0.0,"HAQUE, MD EJAJUL                          (15-30145-2)");
    glColor3f(1,0.5,0);
    drawstring(650,400,0.0,"SUBMITTED TO:");
    glColor3f(1,1,1);
    drawstring(650,370,0.0,"AZM EHTESHAM CHOWDHURY");
    glColor3f(0,1,0);
